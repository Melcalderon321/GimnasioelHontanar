# Reglas del Proyecto — Gimnasio El Hontanar

## Flujo de trabajo y verificaciones

- **No realizar capturas de pantalla automáticas** ("Taking Screenshot") tras cada cambio de código.
- **No ejecutar pruebas visuales ni verificaciones automáticas de interfaz** como paso estándar después de modificar archivos HTML/CSS/JS.
